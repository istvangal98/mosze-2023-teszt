...
int main()
{
    ...
    for (int i = 0; i < N_ELEMENTS; i++) // Hiányzott a < N_ELEMENTS, i++ is hibás volt
    {
        b[i] = i * 2;
    }
    for (int i = 0; i < N_ELEMENTS; i++) // A feltételnek igaznak kell lennie, i++ is hibás volt
    {
    ...
    for (int i = 0; i < N_ELEMENTS; i++) // A vessző helyett pontosvesszőt kell használni és i++ is hibás volt
    {
        atlag += b[i];
    }
    atlag /= N_ELEMENTS;
    ...
    std::cout << "Jó mulatság, férfi munka volt!"<<std::endl;
}